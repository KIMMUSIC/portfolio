...
function Project3({ children, ...restProps }) {

  const pagemove = () =>{
    window.open('https://github.com/KIMMUSIC/portfolio')
  }
  return (
    <div>
      <div class="title">포트폴리오 웹사이트</div>
      <div class="subtitle">개인 프로젝트 2022.10</div>

      <div class="container">
      <div><img class="clothes"  src="./images/misc/port.PNG" alt="HOMEPAGE" /></div>

      <div class="contents">
      <div>
      포트폴리오를 위해 제작한 웹사이트로 React를 사용해 개발하였습니다. 또한 Github Pages를 통해 정적 웹사이트를 호스팅하였습니다.
      홈 화면에 이름과 이메일, 블로그, 깃허브 주소를 기재하였고 Tech Stack과 BaekJoon 프로필을 기재하였습니다.
      Archiving 에는 블로그와 깃허브의 주소, 설명이 있고 Projects에는 제가 했던 팀 프로젝트, 개인 프로젝트들을 올려두었습니다.
      </div>

    
      <div  onClick={pagemove} class="readme"><p >자세히 보기 ▶ Github</p></div>
      <hr/>
      ...
      <span>기술스택, 백준프로필, 아카이빙, 프로젝트</span>
      </div>
      ...
      <span><a href="https://github.com/KIMMUSIC/portfolio">https://github.com/KIMMUSIC/portfolio</a></span>
      </div>
