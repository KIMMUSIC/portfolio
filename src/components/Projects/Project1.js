...
function Project1({ children, ...restProps }) {
  ...
  const pagemove = () =>{
    window.open('https://github.com/KIMMUSIC/clothes/blob/master/README.md')
  }
  return (
    <div>
      ...
      <div class="container">
      <div><img class="clothes"  src="./images/misc/clothes.PNG" alt="HOMEPAGE" /></div>

      <div class="contents">
      <div>
      단순히 통계형 알고리즘을 사용하여 유저에게 추천해주기보다 개개인의 구매 기록 및 나이, 계절 등을 고려하여 개인화된 추천 시스템을 유저에게 제공해주는 홈페이지 입니다.
또한 사용자에게 텍스트 검색 뿐만이 아니라 이미지 & 스케치 이미지 검색 기능을 제공함으로써 사용자는 자신이 가지고 있는 사진으로 홈페이지 내의 비슷한 옷에 대해 검색할 수 있습니다. 
사진이 없을 경우 홈페이지 내에서 제공하는 스케치 기능을 통해 옷을 검색 할 수 있습니다. 이는 사용자가 원하는 옷을 더 정확히 검색하는 기능을 제공 할 뿐만 아니라 쇼핑몰에 대한 흥미를 
유발함으로써 고객을 확보할 수 있는 효과를 지닙니다. 
      </div>
      ...
      <span>유저 기반 & 아이템 기반 추천 시스템, 이미지 검색, 스케치 이미지 검색</span>
      </div>
      ...
      <span>Flask, SqlAlchemy, Pytorch, Naver Cloud</span>
      </div>
      ...
      <span><a href="https://github.com/KIMMUSIC/clothes">https://github.com/KIMMUSIC/clothes</a></span>
      </div>

      <div id ="ex">
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>YouTube</title><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
      <span id="list">Youtube</span>
      <span><a href="https://youtu.be/SzWjEJoL0FA">https://youtu.be/SzWjEJoL0FA</a></span>
      </div>
      </div>
